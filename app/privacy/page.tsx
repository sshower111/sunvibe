...
export default function PrivacyPage() {
  return <><Navigation /><main id="main-content" tabIndex={-1} className="site-container page-space max-w-3xl"><h1 className="heading-1">Sunville Bakery privacy notice</h1>
    <section className="mt-8 space-y-4"><h2 className="heading-2">Inquiries and festival reservations</h2><p>We use the contact details, message, event information, and reference photos you submit to respond to your inquiry and discuss your order. Our forms send this information to the bakery through our email delivery provider, Resend. Festival reservation details are also stored for bakery staff to review and update their status. If enabled, a short reservation notification is sent to the bakery’s SMS gateway.</p></section>
